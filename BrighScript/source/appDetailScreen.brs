        ...
        if type(msg) = "roSpringboardScreenEvent" then
            if msg.isScreenClosed()
                ...
                if msg.GetIndex() = 2
                    ...
                    ' Play all the videos to the end of the current leaf
                     while showIndex <> -1 
                        ...
                        if result = 15
                            print "Details: User Interrupted. Going to details"
                            exit while
                        endif   
                        
                        if result = 16
                            print "Details: Playback completed. Showing next show"
                            showIndex = getNextShow(showList, showIndex)
                            print "NEW Show Index";showIndex
                        endif
...
Function refreshShowDetail(screen As Object, showList As Object, showIndex as Integer) As Integer
    ...
    screen.ClearButtons()
    screen.AddButton(1, "Play from the begining")    
