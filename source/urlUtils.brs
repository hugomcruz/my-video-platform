...
REM ******************************************************
REM Constucts a URL Transfer object - Send token
REM ******************************************************

Function CreateURLTransferObjectToken(url As String, token as String) as Object
    obj = CreateObject("roUrlTransfer")
    obj.SetPort(CreateObject("roMessagePort"))
    obj.SetUrl(url)
    obj.AddHeader("Content-Type", "application/x-www-form-urlencoded")
    obj.AddHeader("token",token)
    obj.EnableEncodings(true)
    return obj
End Function
...
Function NewHttpToken(url As String, token as String) as Object
    obj = CreateObject("roAssociativeArray")
    obj.Http                        = CreateURLTransferObjectToken(url, token)
    obj.FirstParam                  = true
